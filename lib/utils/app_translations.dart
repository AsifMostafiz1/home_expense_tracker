...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en_US': {
          ...
          'confirm_edit_my_meal': 'Are you sure you want to change your meal count from @old to @new on @date?',
          ...
          'admin_self_edit_hint': 'Admin: tap a day to edit your own meals',
          ...
          'confirm_delete_my_expense': 'Are you sure you want to delete this expense?',
          ...
          'my_ledger': 'My Ledger',
          // report
          'personal_report': 'Money report',
          'personal_report_subtitle':
              'Sort your income and spending by category, tag and date',
          'period_this_month': 'This month',
          'period_last_month': 'Last month',
          'period_three_months': 'Last 3 months',
          'period_this_year': 'This year',
          'period_custom': 'Pick dates',
          'period_six_months': 'Last 6 months',
          'period_last_year': 'Last year',
          'period_all_time': 'All time',
          'period_custom_hint': 'Tap to choose the dates',
          'period_label': 'Period',
          'report_type': 'Type',
          'report_type_all': 'All — income & expense',
          'subcategory_label': 'Sub-category',
          'all_categories': 'All categories',
          'n_selected': '@count selected',
          'entries_match': '@count entries match',
          ...
          'failed_create_pdf': 'Could not create the PDF',
          'report_pdf': 'Report PDF',
          'report_word': 'Report',
          'report_tagline': 'Personal income & expense',
          ...
          'and_more_rows': '+ @count more',
          'by_category': 'By category',
          'by_subcategory': 'By sub-category',
          'untagged': 'Untagged',
          'report_empty': 'Nothing matches this selection.',
          ...
          'wallet_ahead_of': 'Where it lands at the end of @month',
          ...
          'call_was_declined': 'Call declined',
          'call_declined': 'Declined call',
          'call_unanswered': 'No answer',
          'call_failed': 'Could not connect the call',
          'already_in_a_call': 'You are already on a call',
          'accept': 'Accept',
          'decline': 'Decline',
          'end_call': 'End',
          'mute': 'Mute',
          'speaker': 'Speaker',
          'hold_to_record': 'Hold the microphone to record',
          'slide_to_cancel': 'Slide to cancel',
          'release_to_cancel': 'Release to cancel',
          'mic_permission_needed':
              'MessBook needs the microphone to record a voice message',
          'failed_record_voice': 'Could not start recording',
          'voice_play_failed': 'Could not play',
          ...
          // ------------------------------------------------------------ tasks
          // A member's own to-do list, and the reminders it sets.
          'my_tasks': 'My Tasks',
          'my_tasks_subtitle': 'What you have to do, with reminders',
          'tasks_today_pill': '@count today',
          'tasks_overdue_pill': '@count overdue',
          'add_task': 'Add task',
          'new_task': 'New task',
          'edit_task': 'Edit task',
          'task_editor_hint':
              'A day, an hour and a reminder are all optional — add what helps.',
          'task_title': 'What needs doing?',
          'task_title_hint': 'e.g. Pay the electricity bill',
          'task_title_required': 'Give the task a name',
          'task_note_optional': 'Note (optional)',
          'task_note_hint': 'Anything you want to remember with it',
          'when_label': 'When',
          'no_date': 'No date',
          ...
          'remind_minutes_before': '@count min before',
          'remind_hours_before': '@count hr before',
          'remind_day_before': '1 day before',
          'remind_morning_of': 'Morning of (9:00 AM)',
          'remind_evening_before': 'Evening before (8:00 PM)',
          'reminder_will_ring': 'Rings @when',
          'reminder_time_passed':
              'That moment has already passed — no reminder will ring.',
          'reminders_need_phone': 'Reminders ring on the phone app',
          'follow_up_label': 'If still not done',
          'follow_up_off': 'Off',
          'follow_up_after_minutes': '@count min after',
          'follow_up_after_hours': '@count hr after',
          'follow_up_preview': 'Reminds again at @time if it is still not done',
          'priority': 'Priority',
          'priority_low': 'Low',
          ...
          'task_saved_offline':
              'Saved on this phone — it syncs when you are back online',
          'task_deleted': 'Task deleted',
          'failed_save_task': 'Could not save the task',
          'failed_delete_task': 'Could not delete the task',
          'failed_load_tasks': 'Could not load your tasks',
          'delete_task': 'Delete task',
          'confirm_delete_task': 'This task and its reminder will be removed.',
          'confirm_delete_repeating_task':
              'This task repeats. Deleting it ends the series — it will not come back.',
          'task_done_next_on': 'Done · next: @date',
          'task_moved_to': 'Moved to @date',
          ...
          'section_later': 'Later',
          'section_someday': 'Someday',
          'section_completed': 'Completed',
          'tasks_progress': '@done of @total done today',
          'tasks_all_done': 'All done for today',
          'tasks_all_done_hint':
              'Nothing left on your list. Enjoy the rest of the day.',
          'tasks_none_today': 'Nothing due today',
          'tasks_none_today_hint':
              'Your day is clear. Add something, or rest easy.',
          'next_up': 'Next: @title · @when',
          'tasks_overdue_count': '@count overdue',
          'overdue_from_earlier': '@count left over from earlier days',
          'open_tasks_count': '@count open',
          'no_tasks_yet': 'No tasks yet',
          'no_tasks_hint':
              'Write down what needs doing, give it a day if it has one, and MessBook will remind you.',
          'add_first_task': 'Add your first task',
          'all_caught_up': 'You are all caught up',
          'all_caught_up_hint':
              'Nothing open on your list. Add the next thing when it comes to mind.',
          'no_completed_tasks': 'Nothing finished yet',
          'no_completed_tasks_hint':
              'Tick a task off and it will show up here.',
          'clear_completed': 'Clear completed',
          'confirm_clear_completed':
              'Remove every finished task from the list? The ones still open stay.',
          'completed_cleared': '@count finished tasks cleared',
          'completed_cleared_one': '1 finished task cleared',
          'todays_tasks': "Today's tasks",
          'today_sheet_summary': '@total tasks today · @done done',
          'today_sheet_summary_one': '1 task today · @done done',
          'open_my_tasks': 'Open my tasks',
          'later': 'Later',
          'exact_alarms_hint':
              'Reminders may arrive a few minutes late on this phone. Allow exact alarms to ring on the minute.',
          'allow_exact_alarms': 'Allow exact alarms',
          'notifications_off_hint':
              'Notifications are turned off for MessBook, so reminders cannot show. Turn them on in Settings.',
          'test_reminder': 'Send a test reminder',
          'test_reminder_sent': 'A test reminder will arrive in 10 seconds',
          'done_today_count': '@count done today',
          'weekday_mon': 'Mon',
          'weekday_tue': 'Tue',
          'weekday_wed': 'Wed',
          'weekday_thu': 'Thu',
        ...
        'bn_BD': {
          ...
          'confirm_edit_my_meal': 'আপনি কি নিশ্চিত যে আপনি @date তারিখে নিজের মিল সংখ্যা @old থেকে পরিবর্তন করে @new করতে চান?',
          ...
          'admin_self_edit_hint': 'অ্যাডমিন: নিজের মিল সম্পাদনা করতে যেকোনো দিনে ট্যাপ করুন',
          ...
          'confirm_delete_my_expense': 'আপনি কি নিশ্চিত যে আপনি এই খরচটি মুছে ফেলতে চান?',
          ...
          // report
          'personal_report': 'আয়-ব্যয়ের রিপোর্ট',
          'personal_report_subtitle':
              'খাত, ট্যাগ আর তারিখ ধরে আয়-খরচ বাছাই করে দেখুন',
          'period_this_month': 'এই মাস',
          'period_last_month': 'গত মাস',
          'period_three_months': 'গত ৩ মাস',
          'period_this_year': 'এই বছর',
          'period_custom': 'তারিখ বাছুন',
          'period_six_months': 'গত ৬ মাস',
          'period_last_year': 'গত বছর',
          'period_all_time': 'শুরু থেকে',
          'period_custom_hint': 'তারিখ বাছতে চাপ দিন',
          'period_label': 'সময়কাল',
          'report_type': 'ধরন',
          'report_type_all': 'সব — আয় ও খরচ',
          'subcategory_label': 'সাব-খাত',
          'all_categories': 'সব খাত',
          'n_selected': '@count টি নির্বাচিত',
          'entries_match': '@count টি এন্ট্রি মিলছে',
          'generate_report': 'রিপোর্ট তৈরি করুন',
          'report_view': 'রিপোর্ট',
          'transactions_label': 'লেনদেন',
          'pages_label': 'পাতা',
          'create_pdf': 'PDF বানান',
          'creating_pdf': 'PDF তৈরি হচ্ছে…',
          'failed_create_pdf': 'PDF তৈরি করা যায়নি',
          'report_pdf': 'রিপোর্ট PDF',
          'report_word': 'রিপোর্ট',
          'report_tagline': 'ব্যক্তিগত আয়-ব্যয়',
          'generated_on': 'তৈরি: @date',
          'continued_next_page': 'পরের পাতায় চলবে…',
          'page_of': 'পাতা @n / @m',
          'col_date': 'তারিখ',
          'col_time': 'সময়',
          ...
          'prepared_for': 'যার হিসাব',
          'and_more_rows': '+ আরও @count টি',
          'by_category': 'খাত অনুযায়ী',
          'by_subcategory': 'সাব-খাত অনুযায়ী',
          'untagged': 'ট্যাগ ছাড়া',
          'report_empty': 'এই বাছাইয়ে কোনো এন্ট্রি নেই।',
          ...
          'wallet_ahead_of': '@month শেষে যা দাঁড়াবে',
          ...
          'audio_call': 'ভয়েস কল',
          'incoming_audio_call': 'ভয়েস কল আসছে',
          'missed_audio_call': 'মিসড ভয়েস কল',
          'calling': 'কল করা হচ্ছে…',
          'call_connecting': 'সংযোগ হচ্ছে…',
          'call_ended': 'কল শেষ',
          'call_was_declined': 'কল কেটে দেওয়া হয়েছে',
          'call_declined': 'কল কেটে দেওয়া হয়েছে',
          'call_unanswered': 'কেউ ধরেনি',
          'call_failed': 'কল সংযোগ করা যায়নি',
          'already_in_a_call': 'আপনি এখন একটি কলে আছেন',
          'accept': 'গ্রহণ',
          'decline': 'বাতিল',
          'end_call': 'শেষ করুন',
          'mute': 'মিউট',
          'speaker': 'স্পিকার',
          'hold_to_record': 'রেকর্ড করতে মাইকে চেপে ধরে রাখুন',
          'slide_to_cancel': 'বাতিল করতে স্লাইড করুন',
          'release_to_cancel': 'ছেড়ে দিলে বাতিল হবে',
          'mic_permission_needed':
              'ভয়েস মেসেজ রেকর্ড করতে MessBook এর মাইক্রোফোন প্রয়োজন',
          'failed_record_voice': 'রেকর্ডিং শুরু করা যায়নি',
          'voice_play_failed': 'চালানো যায়নি',
          ...
          // A member's own to-do list, and the reminders it sets.
          'my_tasks': 'আমার কাজ',
          'my_tasks_subtitle': 'যা করতে হবে, রিমাইন্ডারসহ',
          'tasks_today_pill': 'আজ @count টি',
          'tasks_overdue_pill': '@count টি বকেয়া',
          'add_task': 'কাজ যোগ করুন',
          'new_task': 'নতুন কাজ',
          'edit_task': 'কাজ সম্পাদনা',
          'task_editor_hint':
              'দিন, সময় আর রিমাইন্ডার — সবই ঐচ্ছিক। যেটা কাজে লাগে সেটা দিন।',
          'task_title': 'কী করতে হবে?',
          'task_title_hint': 'যেমন: বিদ্যুৎ বিল দেওয়া',
          'task_title_required': 'কাজটির একটি নাম দিন',
          'task_note_optional': 'নোট (ঐচ্ছিক)',
          'task_note_hint': 'এর সাথে যা মনে রাখতে চান',
          'when_label': 'কখন',
          'no_date': 'তারিখ নেই',
          'pick_date': 'তারিখ বাছুন',
          'add_time': 'সময় যোগ করুন',
          'all_day': 'সারাদিন',
          'remind_me': 'মনে করিয়ে দিন',
          'no_reminder': 'রিমাইন্ডার নেই',
          'remind_at_time': 'ঠিক সময়ে',
          'remind_minutes_before': '@count মিনিট আগে',
          'remind_hours_before': '@count ঘণ্টা আগে',
          'remind_day_before': '1 দিন আগে',
          'remind_morning_of': 'সেদিন সকালে (9:00)',
          'remind_evening_before': 'আগের দিন সন্ধ্যায় (8:00)',
          'reminder_will_ring': '@when বাজবে',
          'reminder_time_passed':
              'সে সময় পেরিয়ে গেছে — কোনো রিমাইন্ডার বাজবে না।',
          'reminders_need_phone': 'রিমাইন্ডার ফোন অ্যাপে বাজে',
          'follow_up_label': 'সময়মতো না হলে',
          'follow_up_off': 'বন্ধ',
          'follow_up_after_minutes': '@count মিনিট পর',
          'follow_up_after_hours': '@count ঘণ্টা পর',
          'follow_up_preview': 'তখনও না হলে @time-এ আবার মনে করাবে',
          'priority': 'গুরুত্ব',
          'priority_low': 'কম',
          ...
          'task_added': 'কাজ যোগ হয়েছে',
          'task_saved': 'কাজ সংরক্ষিত',
          'task_saved_offline':
              'এই ফোনে সংরক্ষিত — অনলাইনে ফিরলে সিঙ্ক হবে',
          'task_deleted': 'কাজ মুছে ফেলা হয়েছে',
          'failed_save_task': 'কাজটি সংরক্ষণ করা যায়নি',
          'failed_delete_task': 'কাজটি মোছা যায়নি',
          'failed_load_tasks': 'কাজের তালিকা লোড করা যায়নি',
          'delete_task': 'কাজ মুছুন',
          'confirm_delete_task': 'কাজটি ও এর রিমাইন্ডার মুছে যাবে।',
          'confirm_delete_repeating_task':
              'এই কাজটি বারবার আসে। মুছলে ধারাটি শেষ হবে — আর ফিরে আসবে না।',
          'task_done_next_on': 'সম্পন্ন · পরেরটি: @date',
          'task_moved_to': 'সরানো হয়েছে — @date',
          'move_to_today': 'আজকে সরান',
          'move_to_tomorrow': 'আগামীকালে সরান',
          'mark_done': 'সম্পন্ন করুন',
          'mark_not_done': 'অসম্পন্ন করুন',
          'view_open': 'করতে হবে',
          'view_done': 'সম্পন্ন',
          'section_overdue': 'সময় পেরিয়েছে',
          'section_later': 'পরে',
          'section_someday': 'কোনো একদিন',
          'section_completed': 'সম্পন্ন',
          'tasks_progress': 'আজ @total টির মধ্যে @done টি সম্পন্ন',
          'tasks_all_done': 'আজকের সব কাজ শেষ',
          'tasks_all_done_hint':
              'তালিকায় আর কিছু বাকি নেই। দিনের বাকিটা উপভোগ করুন।',
          'tasks_none_today': 'আজ কোনো কাজ নেই',
          'tasks_none_today_hint':
              'আজকের দিন ফাঁকা। কিছু যোগ করুন, অথবা নির্ভার থাকুন।',
          'next_up': 'পরবর্তী: @title · @when',
          'tasks_overdue_count': '@count টি বকেয়া',
          'overdue_from_earlier': 'আগের দিনের @count টি কাজ বকেয়া',
          'open_tasks_count': '@count টি বাকি',
          'no_tasks_yet': 'এখনো কোনো কাজ নেই',
          'no_tasks_hint':
              'যা করতে হবে লিখে রাখুন, দিন থাকলে দিনটাও দিন — MessBook মনে করিয়ে দেবে।',
          'add_first_task': 'প্রথম কাজটি যোগ করুন',
          'all_caught_up': 'সব কাজ শেষ',
          'all_caught_up_hint':
              'তালিকায় কিছু বাকি নেই। মনে পড়লে পরের কাজটি যোগ করুন।',
          'no_completed_tasks': 'এখনো কিছু শেষ হয়নি',
          'no_completed_tasks_hint':
              'কোনো কাজে টিক দিলে সেটি এখানে দেখা যাবে।',
          'clear_completed': 'সম্পন্ন কাজ মুছুন',
          'confirm_clear_completed':
              'সব সম্পন্ন কাজ তালিকা থেকে মুছে ফেলবেন? বাকি কাজগুলো থাকবে।',
          'completed_cleared': '@count টি সম্পন্ন কাজ মুছে ফেলা হয়েছে',
          'completed_cleared_one': '১টি সম্পন্ন কাজ মুছে ফেলা হয়েছে',
          'todays_tasks': 'আজকের কাজ',
          'today_sheet_summary': 'আজ @total টি কাজ · @done টি সম্পন্ন',
          'today_sheet_summary_one': 'আজ ১টি কাজ · @done টি সম্পন্ন',
          'open_my_tasks': 'আমার কাজ দেখুন',
          'later': 'পরে',
          'exact_alarms_hint':
              'এই ফোনে রিমাইন্ডার কয়েক মিনিট দেরিতে আসতে পারে। ঠিক মিনিটে বাজাতে নির্ভুল অ্যালার্মের অনুমতি দিন।',
          'allow_exact_alarms': 'নির্ভুল অ্যালার্ম চালু করুন',
          'notifications_off_hint':
              'MessBook-এর নোটিফিকেশন বন্ধ, তাই রিমাইন্ডার দেখানো যাবে না। সেটিংস থেকে চালু করুন।',
          'test_reminder': 'একটি পরীক্ষামূলক রিমাইন্ডার পাঠান',
          'test_reminder_sent': '১০ সেকেন্ডে একটি পরীক্ষামূলক রিমাইন্ডার আসবে',
          'done_today_count': 'আজ @count টি সম্পন্ন',
          'weekday_mon': 'সোম',
          'weekday_tue': 'মঙ্গল',
          'weekday_wed': 'বুধ',
          'weekday_thu': 'বৃহঃ',
          ...
          'weekday_sat': 'শনি',
          'weekday_sun': 'রবি',
          'weekday_full_mon': 'সোমবার',
          'weekday_full_tue': 'মঙ্গলবার',
          'weekday_full_wed': 'বুধবার',
          'weekday_full_thu': 'বৃহস্পতিবার',
          'weekday_full_fri': 'শুক্রবার',
          'weekday_full_sat': 'শনিবার',
          'weekday_full_sun': 'রবিবার',
